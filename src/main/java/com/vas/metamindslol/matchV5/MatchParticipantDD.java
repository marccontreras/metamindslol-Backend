...
public class MatchParticipantDD implements Serializable {
    ...
    @GenericGenerator(name = "MatchParticipant-sequence-generator")
    private long id;
    private int assists;
