...
public class BaseSpellData
{
    ...
    public int hashCode()
    {
        return Objects.hash(cooldown, cooldownBurn, cost, costBurn, costType, description, effect, effectBurn, image, key, leveltip, maxrank, id, range, rangeBurn, resource, tooltip, vars);
    }
